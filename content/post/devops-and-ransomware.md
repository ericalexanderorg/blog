...
Does DevOps pass the “so what?” test? When you start to follow the history of DevOps from Agile, Lean, Theory of Constraints (TOS), Total Quality Management (TQM), Toyota Production Systems (TPS), Statistical Process Control, scientific method, and maybe all the way back to the ancients: Socrates, Plato, and Aristotle - It starts to beg the question: Is DevOps anything special, or is it just critical thinking? If it’s so simple, than what's the road block? Why would Jeff Bezos, the world's richest person, [pay an “insultant” to teach him](https://youtu.be/O4MtQGRIIuA?t=1250)? Jeff seems to understand that eliminating waste is important, that you should never pass a defect down the line, but he seems to discard the sweeping question as too abstract, and not useful. 

...
It starts to beg the question: Is DevOps anything special, or is it just critical thinking? If it’s so simple, anyone can do it, then why do so few organizations do it? Why would Jeff Bezos, the world's richest person, [pay an “insultant” to teach him](https://youtu.be/O4MtQGRIIuA?t=1250)? Jeff seems to understand that eliminating waste is important, that you should never pass a defect down the line, but he seems to discard the sweeping question as too abstract, and not useful. 
